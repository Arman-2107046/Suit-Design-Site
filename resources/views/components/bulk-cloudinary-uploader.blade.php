...
<div
    x-data="{
        ...
        cloudName: @js(config('cloudinary.cloud_name')),
        uploadPreset: @js(config('cloudinary.upload_preset')),
        ...
        async uploadAll() {
            ...
            if (payload.length > 0) {
                ...
                try {
                    ...
                    await this.$wire.{{ $wireMethod }}(payload);
                    ...
                    console.error(
                        'Livewire processing failed:',
                        error
                    );

                    alert(
                        'Images were uploaded, but the server failed to process them.'
                    );
                }
            }
        },
            ...
            >
                ...
                >
                    ...
                    <span
                        ...
                        x-bind:style="{
                            pending:
                                'flex-shrink: 0; font-size: 11px; font-weight: 600; color: #9ca3af; background: #f3f4f6; padding: 3px 10px; border-radius: 999px;',

                            uploading:
                                'flex-shrink: 0; font-size: 11px; font-weight: 600; color: #6366f1; background: #eef2ff; padding: 3px 10px; border-radius: 999px;',

                            done:
                                'flex-shrink: 0; font-size: 11px; font-weight: 600; color: #15803d; background: #dcfce7; padding: 3px 10px; border-radius: 999px;',

                            error:
                                'flex-shrink: 0; font-size: 11px; font-weight: 600; color: #dc2626; background: #fee2e2; padding: 3px 10px; border-radius: 999px;',
                        }[f.status]"
                    ></span>
